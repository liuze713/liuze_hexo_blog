!function (e, t) {
  ...
  var U = function () {
    ...
    }(), V = !/(iphone|ipad|ipod|ios|android)/i.test(navigator.userAgent.toLowerCase()), q = v("qqbrowser"),
    F = v("firefox"), X = v("macintosh"), B = v("edge"), h = B && !v("chrome") || v("trident") || v("msie"),
    p = v("crios"), M = v("edgios"), N = v("chrome") || p;
  ...
  var j, _ = function () {
    ...
    function t() {
      return i(this, t), e.call(this, {type: j.RegToString, enabled: q || F})
    }
  ...
  var E, fe = function () {
      ...
      function t() {
        return i(this, t), e.call(this, {type: j.FuncToString, enabled: !p && !M})
      }
